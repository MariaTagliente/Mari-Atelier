    ...
    <header className="bg-(--panna) text-(--colorTesto)">
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-2 items-center gap-14">
          ...
          <div>
            <h1 className="text-4xl font-cormorant font-semibold">
              Ogni creazione
            </h1>

            <h2 className="font-alexBrush text-5xl text-(--rosaDark)">
              racconta una storia.
            </h2>
            ...
            <p className="text-lg leading-8 text-(--colorTesto) max-w-4/5">
