        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-14">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-col justify-center items-center md:flex-row md:justify-start gap-5 md:gap-8 mt-6 md:mt-8">
              ...
              <a href="#collezioni" className="bg-(--rosaDark) text-white px-10 py-4 rounded-full uppercase tracking-wider font-medium shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
          ...
          <div className="relative">
            <div className="absolute -z-10 top-8 right-4 w-96 h-96 rounded-full bg-(--rosaLight) blur-[140px] opacity-40"/>
