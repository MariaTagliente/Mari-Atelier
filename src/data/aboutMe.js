...
export const aboutMe = {
    ...
    description: `
        Sono Maria, la creativa dietro Mari Atelier.

        Il mio amore per l'uncinetto nasce grazie a mia mamma, che mi ha fatto scoprire la bellezza di questa tecnica e il valore delle creazioni realizzate a mano.

        Amo ricercare idee particolari, sperimentare nuovi dettagli e trasformare ogni progetto in una creazione curata, dedicando tempo e passione a ogni singolo pezzo.
